...
<head>
    ...
    <title>Database Backup - CBT Sync</title>
    <style>
        :root {
            --primary: #6366f1;
    ...
    <div class="app-layout">
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    <li><a href="dashboard.php"><span class="icon"><svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16"><path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L2 8.207V13.5A1.5 1.5 0 0 0 3.5 15h9a1.5 1.5 0 0 0 1.5-1.5V8.207l.646.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.707 1.5zM13 7.207V13.5a.5.5 0 0 1-.5.5h-9a.5.5 0 0 1-.5-.5V7.207l5-5 5 5z"/></svg></span> <span>Dashboard</span></a></li>
                    ...
                    <li><a href="backup.php" class="active"><span class="icon"><svg width="18" height="18" fill="currentColor" viewBox="0 0 16 16"><path d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm0 5.996V14H3s-1 0-1-1 1-4 6-4c.564 0 1.077.038 1.544.107a4.524 4.524 0 0 0-.803.918A10.46 10.46 0 0 0 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h5ZM9 13a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm4-2.5a.5.5 0 0 1 .5.5v1.5a.5.5 0 0 1-.5.5h-1.5a.5.5 0 0 1 0-1H13V11a.5.5 0 0 1 .5-.5ZM13 7.5a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 .5.5v1.5a.5.5 0 0 1-1 0V8h-1a.5.5 0 0 1-.5-.5ZM5.5 5A.5.5 0 0 1 5 4.5V3a.5.5 0 0 1 .5-.5h1.5a.5.5 0 0 1 0 1H6V4a.5.5 0 0 1-.5.5Z"/></svg></span> <span>Backup</span></a></li>
        ...
        <nav class="bottom-bar">
            <div class="bottom-nav">
                ...
                <a href="backup.php" class="bottom-nav-item active">
                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
